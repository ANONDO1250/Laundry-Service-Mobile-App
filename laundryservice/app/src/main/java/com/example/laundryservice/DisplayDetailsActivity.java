...
public class DisplayDetailsActivity extends AppCompatActivity {
    ...
    private void showCustomerAndOrderDetails(int position) {
        ...
        if (customerCursor.moveToFirst()) {
            @SuppressLint("Range") String customerAddress = customerCursor.getString(customerCursor.getColumnIndex("address"));
            @SuppressLint("Range") String customerEmail = customerCursor.getString(customerCursor.getColumnIndex("email"));
            @SuppressLint("Range") String creationDate = customerCursor.getString(customerCursor.getColumnIndex("creation_date"));
            @SuppressLint("Range") String phone = customerCursor.getString(customerCursor.getColumnIndex("phone"));
            ...
            if (orderCursor.moveToFirst()) {
                @SuppressLint("Range") String orderItems = orderCursor.getString(orderCursor.getColumnIndex("items"));
                @SuppressLint("Range") double orderTotalPrice = orderCursor.getDouble(orderCursor.getColumnIndex("total_price"));
                @SuppressLint("Range") double duePayment = orderCursor.getDouble(orderCursor.getColumnIndex("status")); // Retrieve due payment
